                    ...
                    return (
                      <div key={post?._id} className={styles.singleCard}>
                        <div className={styles.singleCard__profileContainer}>
                          <img
                            className={styles.singleCard__profileImage}
                            width={100}
              ...
              className={styles.commentsContainer}>
                  ...
                  className={styles.allcommentsContainer}>
                      {postState.comments.length === 0  && <h2>No comments</h2> }
                      {
                        ...
                        <div className={styles.commentsScrollWrapper}>
                          { Array.isArray(postState.comments) && postState.comments.map((comment,index)=>(
                            <div key={index} className={styles.singleComment}>
                              <div className={styles.singleComment_profileContainer}>
                                <img src={`${baseURL}/${comment.userId?.profilePicture || ""}`} alt="profile"/>
                                <div>
                                  <p style={{fontWeight:"bold" , fontSize: "1.2rem"}}>{comment.userId?.name || "Unknown User"}</p>
